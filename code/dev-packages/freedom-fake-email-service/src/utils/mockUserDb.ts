...
import { EmailUserId } from 'freedom-email-sync';
import { CombinationCryptoKeySet, combinationCryptoKeySetSchema } from 'freedom-crypto-data';
...
export const addUser = makeAsyncResultFunc(
  [import.meta.filename, 'addUser'],
  async (trace, user: User): PR<User> => {
