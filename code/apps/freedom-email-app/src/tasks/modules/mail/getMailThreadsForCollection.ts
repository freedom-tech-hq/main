...
import { getBundleFileAtPath, getConflictFreeDocumentFromBundleAtPath, getJsonFromFileAtPath } from 'freedom-syncable-store-types';
...
export const getMailThreadsForCollection = makeAsyncResultFunc(
  ...
  async (
    ...
    const mailStorageBundle = await getBundleFileAtPath(
      trace,
      userFs.value,
